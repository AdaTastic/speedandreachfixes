...
namespace SpeedandReachFixes
{
    ...
    public class Settings
    {
        ...
        public List<WeaponStats> WeaponStats { get; set; } = new()
        {
            ...
            new WeaponStats(1, false, Skyrim.Keyword.WeapTypeDagger, .6F, 0.533F),
            new WeaponStats(1, false, Skyrim.Keyword.WeapTypeGreatsword, 0.6F, 0.88F),
            new WeaponStats(1, false, Skyrim.Keyword.WeapTypeMace, 0.6F, 0.75F),
            new WeaponStats(1, false, Skyrim.Keyword.WeapTypeSword, .6F, 0.83F),
            new WeaponStats(1, false, Skyrim.Keyword.WeapTypeWarAxe, .6F, 0.6F),
            ...
            new WeaponStats(2, true, NewArmoury.Keyword.WeapTypeHalberd, Constants.NullFloat, 0.15F),
